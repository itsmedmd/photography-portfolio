...
exports.handler = async (event) => {
    ...
    await postHTMLFile("projects/photography-portfolio/preview/videos/index.html", createVideosPageContent(lines));
...
async function getMyObject() {
  return new Promise(function(resolve, reject) {
      s3.getObject(
          { Bucket: bucketName, Key: 'projects/photography-portfolio/preview/videos/source.txt' },
          function (error, data) {
  ...
  return `
    ...
    <html lang="en">
      <head>
        ...
        <title>Deimantas Butėnas - Photography Portfolio - Videos</title>
      </head>
      <body>
        <div id="fb-root"></div>
