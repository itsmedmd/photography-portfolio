...
const s3 = new AWS.S3();
const bucketName = "www.deimantasb.com";
...
exports.handler = async (event) => {
    ...
    let allKeys = await getAllKeys({
      Bucket: bucketName,
      Prefix: 'projects/photography-portfolio/preview/images/'
    });
    
    allKeys = allKeys.map(key => key.split("projects/photography-portfolio/preview/")[1]);
    ...
    for(const galleryName of galleryNames) {
      ...
      newDeleted.forEach(item => {
        toDelete.push(
          {'Key': `projects/photography-portfolio/preview/images/${galleryName}/thumbnails/${item}`},
          {'Key': `projects/photography-portfolio/preview/images/${galleryName}/blurry/${item}`},
          {'Key': `projects/photography-portfolio/preview/images/${galleryName}/compressed-small/${item}`},
          {'Key': `projects/photography-portfolio/preview/images/${galleryName}/compressed-big/${item}`}
        );
      });
          ...
          toUpload.push(
            {
              Bucket: bucketName,
              Key: `projects/photography-portfolio/preview/images/${galleryName}/thumbnails/${item}`,
              Body: await resizeAndCompress(`projects/photography-portfolio/preview/images/${galleryName}/original-images/${item}`, 'thumbnails', 100, 70, 'fill'),
              ContentType: 'image'
            },
            {
              Bucket: bucketName,
              Key: `projects/photography-portfolio/preview/images/${galleryName}/blurry/${item}`,
              Body: await resizeAndCompress(`projects/photography-portfolio/preview/images/${galleryName}/original-images/${item}`, 'blurry', 400, 0, 'inside'),
              ContentType: 'image'
            },
            {
              Bucket: bucketName,
              Key: `projects/photography-portfolio/preview/images/${galleryName}/compressed-small/${item}`,
              Body: await resizeAndCompress(`projects/photography-portfolio/preview/images/${galleryName}/original-images/${item}`, 'compressed-small', 400, 0, 'inside'),
              ContentType: 'image'
            },
            {
              Bucket: bucketName,
              Key: `projects/photography-portfolio/preview/images/${galleryName}/compressed-big/${item}`,
              Body: await resizeAndCompress(`projects/photography-portfolio/preview/images/${galleryName}/original-images/${item}`, 'compressed-big', 1000, 0, 'inside'),
              ContentType: 'image'
            }
          );
      }
      ...
      await resizeCompressUploadGalleryImg("projects/photography-portfolio/preview/images/" + getGalleryIMG(allKeys, galleryName));
    }
    ...
    await postHTMLFile("projects/photography-portfolio/preview/galleries/index.html", allGalleriesPageContent);
    ...
    for(let i = 0; i < galleryNames.length; i++) {
      ...
      await postHTMLFile(`projects/photography-portfolio/preview/galleries/${i + 1}/index.html`, galleryPageContent);
    };
...
function filterByFolder(allKeys, galleryName, folderName, result = []) {
  allKeys.forEach(key => {
    ...
    if(splitUp[4] === galleryName && splitUp[5] === folderName)
      result.push(splitUp[6]);
  });
  return result;
}
...
async function resizeCompressUploadGalleryImg(key) {
  ...
  // splitUp[4] is gallery name
  await s3.putObject({
    Bucket: bucketName,
    Key: `projects/photography-portfolio/preview/images/${splitUp[4]}/gallery-img-resized.${extension[1]}`,
    Body: buffer,
    ContentType: "image"
  }).promise();
}
  ...
  return `
    ...
    <html lang="en">
      <head>
        ...
        <title>Deimantas Butėnas - Photography Portfolio - Photos</title>
      </head>
      <body>
        <div id="fb-root"></div>
        ...
        <header class="photo-gallery-header">
          <a href="https://deimantasb.com/projects/photography-portfolio/preview/" class="page-logo">
          ...
          <nav id="top-navigation">
            <ul class="navigation">
              <li>
                  <a href="https://deimantasb.com/projects/photography-portfolio/preview/galleries/" title="Go to galleries page">Photo Gallery</a>
                  <span class="nav-dot"></span>
              </li>
              <li>
                  <a href="https://deimantasb.com/projects/photography-portfolio/preview/videos/" title="Go to videos page">Video gallery</a>
                  <span class="nav-dot"></span>
              </li>
              <li>
                  <a href="https://deimantasb.com/projects/photography-portfolio/preview/about/" title="Go to about page">About</a>
                  <span class="nav-dot"></span>
              </li>
              <li>
                  <a href="https://deimantasb.com/projects/photography-portfolio/preview/contact/" title="Go to contact page">Contact</a>
              </li>
            </ul>
          </nav>
  ...
  gallerySet.forEach((galleryName, index) => {
    ...
    toRender.push(`
      <div class="box box-border cursor noSelect">
        <a href="https://deimantasb.com/projects/photography-portfolio/preview/galleries/${index + 1}/">
          <div class="box-title">
  ...
  return `
    ...
    <html lang="en">
      <head>
        ...
        <title>Deimantas Butėnas - Photography Portfolio - Galleries</title>
      </head>
      <body>
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v7.0"></script>
